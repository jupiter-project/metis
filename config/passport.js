      ...
      eventEmitter.on('sent_jupiter_to_new_account', () => {
        ...
        user.create()
          .then(() => {
            ...
            return done(null, user, req.flash('signupMessage', 'Account created! Please wait a couple of minutes before logging in while your account is saved in the blockchain'));
          })
          .catch((err) => {
            console.log(err);
            let errorMessage;
