...
class Gravity {
  ...
  loadAppData() {
    ...
    return new Promise(function(resolve, reject) {
      ...
      eventEmitter.on('loaded_records', function() {
        ...
        if (records != undefined && records.length > 0) {
          ...
          for (var x in records) {
            ...
            if (
              records[x].tables != undefined &&
              records[x].date != undefined &&
              records[x].date != null
            ) {
      ...
      self
        .get_records(account, account, passphrase)
        ...
        if (pending_records.length > 0) {
          ...
          pending_records.map(function(p, index) {
            var this_url =
              ...
              '/nxt?requestType=readMessage&transaction=' +
              p +
              '&secretPhrase=' +
              record_passphrase;
            ...
            axios
              ...
              .then(function(response) {
                try {
                  var decrypted_pending = JSON.parse(
    ...
    return new Promise(function(resolve, reject) {
      ...
      eventEmitter.on('table_retrieved', function() {
        for (var obj of table_data) {
          if (
            obj['attachment']['encryptedMessage']['data'] != null &&
            obj['recipientRS'] != record_table.address
          ) {
            if (scope.show_pending != undefined && scope.show_pending > 0) {
  ...
  getBalance(address = 'undefined') {
    ...
    return new Promise(function(resolve, reject) {
          ...
          .then(response => {
            if (response.data.errorDescription) {
              ...
              if (terminal_called) {
                console.log(
                  'Balance: ' +
                    parseFloat(response.data.balanceNQT) /
              ...
              var response_data = {
                ...
                minimumAppBalance: minimumAppBalance,
                minimumTableBalance: minimumTableBalance,
      ...
      axios
        .get(
          server + '/nxt?requestType=getAccountId&secretPhrase=' + address_owner
        )
        .then(function(response) {
  ...
  createTable() {
    ...
    return new Promise(function(resolve, reject) {
        ...
        self
          ...
          .then(response => {
            ...
            resolve({
              success: true,
              message:
                'Table ' + table_name + ' pushed to the blockchain and funded',
              data: response.data,
              jupiter_response: response.data
            });
          })
      ...
      eventEmitter.on('address_retrieved', function() {
        ...
        var encrypted_table_data = self.encrypt(
          JSON.stringify(table_list_record)
        );
          ...
          .then(function(response) {
            if (
              ...
              console.log(
                'Table ' +
                  table_name +
                  ' pushed to the blockchain and linked to your account'
              );
      ...
      self
        ...
        .then(response => {
          if (response.minimumTableBalance == true) {
            ...
            console.log(
              'Error in creating new table: insufficient table balance.'
            );
            console.log(
              'A minimum of ' +
                parseInt(
        ...
        answer => {
          ...
          rl.question(
            ...
            answer => {
              ...
              console.log('');
              rl.question(
                "You are about to create a Jupiter account which will hold your Gravity app's data. Is the information provided above accurate? Is so, press ENTER. If not, press CTRL+C to cancel and rerun command.\n",
                answer => {
                  ...
                  axios
                    ...
                    .then(function(response) {
                      ...
                      if (
                        ...
                        fs.writeFile('.gravity.js', module_in_string, function(
                          err
                        ) {
                          if (err) {
                          ...
                          fs.writeFile(
                            ...
                            function(err) {
                              ...
                              console.log(
                                '\nIn order to begin saving data into the Jupiter Blockchain, you will need to obtain Jupiter assets from:',
                                configuration.JUPITERSERVER
                              );
                              rl.close();
                            }
                          );
