...
class GravityDocs extends Component {
  render() {
    return (
              ...
              <div className="row p-5" id="docsTop">
                ...
                <div className="col-sm-8 mt-3">
                  ...
                  <section className="" id="installDoc">
                    ...
                    <div className="divider my-3"></div>
                    <p>Alternativley, you can install Gravity globaly by adding
                      the <strong>-g</strong> flag to the end.</p>
                  ...
                  <section className="" id="downloadDoc">
                    ...
                    <p>You can download a copy of the source code from our GitHub
                      page using the this script.</p>
