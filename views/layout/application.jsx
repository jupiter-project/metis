  ...
  render() {
    const links_list = (
      <ul className="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        >
          <a
            className="nav-link"
            href="https://github.com/SigwoTechnologies/jupiter-gravity/wiki"
            target="_blank"
          >
    ...
    const unlogged_header = (
      ...
      >
        ...
        <a
          className="nav-link text-light rounded d-none d-sm-block"
          id="sidenavToggler"
        >
          <i className="fa fa-fw fa-angle-left" />
        </a>
          ...
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
              <a className="nav-link" href="/login">
                <i className="fa fa-fw fa-sign-in" /> Log in
              </a>
            </li>
          </ul>
        </div>
